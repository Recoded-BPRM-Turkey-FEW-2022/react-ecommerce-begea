...
export default function Navbar({ setFoundProduct }) {
  ...
  return (
    <div className=' bg-navbar drop-shadow-[0_8px_24px_rgba(149,157,165,0.2)] mb-[5rem]'>
      <nav className='flex justify-between items-center h-[7.5vh] max-w-7xl m-auto lg:text-base lg:max-w-3xl lg:h-[4.5rem]'>
        <div className='logo text-2xl pl-5 lg:text-base lg:pl-2 lg:text-[1.5rem]'>
          <h1 className='font-bold'>
            <Link to='/'>Shopmop</Link>
          </h1>
        </div>
        <div className='nav-links pr-5 lg:hidden'>
